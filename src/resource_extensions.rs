...
impl ResourceSync {
    ...
    pub(crate) fn has_target_finalizer(&self) -> bool {
        self.metadata
            .finalizers
            .as_ref()
    ...
    pub(crate) fn api(&self, ctx: Arc<crate::controller::Context>) -> Api<Self> {
    ...
    pub(crate) fn finalizers_clone_or_empty(&self) -> Vec<String> {
